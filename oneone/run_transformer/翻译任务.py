...
data = TRANS("/home/nio/personal/magic_repo/oneone/run_transformer/translation2019zh/translation2019zh_train.json")
train_data, valid_data = random_split(data, [train_set_size, valid_set_size])
test_data = TRANS("/home/nio/personal/magic_repo/oneone/run_transformer/translation2019zh/translation2019zh_valid.json")
...
def collote_fn(batch_samples):
    ...
    batch_data = tokenizer(batch_inputs, text_target=batch_targets, padding=True, max_length=max_length, truncation=True, return_tensors="pt")
